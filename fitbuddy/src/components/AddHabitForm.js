      ...
      <div style={styles.emojiRow}>
        {EMOJI_OPTIONS.map(e => (
          <button
            ...
            style={{
              ...styles.emojiBtn,
              background: emoji === e ? 'rgba(138,171,138,0.2)' : 'rgba(255,255,255,0.05)',
              border: emoji === e ? '1.5px solid rgba(138,171,138,0.6)' : '1.5px solid rgba(255,255,255,0.08)',
            }}
            onClick={() => setEmoji(e)}
          >{e}</button>
        ))}
...
const styles = {
  ...
  suggestLabel: {
    ...
    color: '#8a7060', fontWeight: '500', marginBottom: '10px',
  },
  suggestBtn: {
    width: '100%', display: 'flex', alignItems: 'center', gap: '10px',
    padding: '11px 14px', marginBottom: '8px',
    background: 'rgba(50,22,6,0.5)',
  ...
  suggestText: { flex: 1, textAlign: 'left', fontSize: '13px', color: '#f5ede0' },
  suggestGoal: { color: '#8a7060', fontSize: '12px' },
  suggestPlus: { fontSize: '18px', color: '#8aab8a', fontWeight: '300' },
  addBtn: {
    width: '100%', padding: '13px',
    background: 'rgba(138,171,138,0.04)',
    border: '1px dashed rgba(138,171,138,0.28)',
    borderRadius: '14px', fontSize: '13px', fontWeight: '500',
    color: '#8a7060', cursor: 'pointer', marginBottom: '16px',
    fontFamily: 'inherit', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
    transition: 'all 0.2s',
  },
  form: {
    background: 'rgba(40,18,4,0.7)',
    border: '1px solid rgba(138,171,138,0.28)',
    borderRadius: '16px', padding: '20px', marginBottom: '16px',
    backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)',
  },
  formTitle: { margin: '0 0 16px', fontSize: '15px', fontWeight: '600', color: '#f5ede0' },
  label: {
    display: 'block', fontSize: '12px', fontWeight: '500',
    color: '#8a7060', marginBottom: '6px', marginTop: '12px',
